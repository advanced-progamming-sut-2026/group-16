...
public final class ZombossClips {
    ...
    public static final String EGYPT_MISSILE = "768/INITIAL/EFFECTS/ZOMBOSS_MISSILE_EXPLOSION_EGYPT/ZOMBOSS_MISSILE_EXPLOSION_EGYPT.PAM";
    public static final String ICE_MISSILE = "768/FULL/EFFECTS/ZOMBOSS_MISSILE_EXPLOSION_ICEAGE/ZOMBOSS_MISSILE_EXPLOSION_ICEAGE.PAM";
    public static final String DARK_FIREBALL = "768/FULL/EFFECTS/ZOMBOSS_DARK_FIREBALL/ZOMBOSS_DARK_FIREBALL.PAM";
    public static final String SHARK = "768/FULL/EFFECTS/ZOMBOSS_SHARK_PROJECTILE/ZOMBOSS_SHARK_PROJECTILE.PAM";
    public static final String TURBINE = "768/FULL/EFFECTS/ZOMBOSS_TURBINE_WIND/ZOMBOSS_TURBINE_WIND.PAM";
    public static final String FIRE_TILE = "768/FULL/EFFECTS/SCORCHED_EARTH_TILE/SCORCHED_EARTH_TILE.PAM";
    public static final String FIRE_TILE_INTRO_CLIP = "animation";
    public static final String FIRE_TILE_CLIP = "animation2";
    public static final String GLACIER = "768/FULL/EFFECTS/ZOMBOSS_GLACIER_BLOCK/ZOMBOSS_GLACIER_BLOCK.PAM";
    public static final String CHILL_WIND = "768/FULL/EFFECTS/FROSTBITE_CHILL_WIND/FROSTBITE_CHILL_WIND.PAM";
    public static final String ICE_BLOCK_ZOMBIE = "768/FULL/EFFECTS/FROSTBITE_ICE_BLOCK_ZOMBIE/FROSTBITE_ICE_BLOCK_ZOMBIE.PAM";
    public static final String ICE_BLOCK_ZOMBIE_CLIP = "idle";
    public static final String ICE_BLOCK_ZOMBIE_SPAWN = "768/INITIAL/EFFECTS/ICEBLOOM_ICE_BLOCK_ZOMBIE_EFFECT/ICEBLOOM_ICE_BLOCK_ZOMBIE_EFFECT.PAM";
    public static final String ICE_BLOCK_ZOMBIE_SPAWN_CLIP = "animation";
    public static final float ICE_OVERLAY_ALPHA = 0.6f;
    ...
    public static Sequence sequence(String logical) {
        ...
        return switch (logical) {
            ...
            case "suction" ->
                new Sequence(new String[] { "suction_on", "idle" }, new String[] { "suction_loop", "idle" }, true);
