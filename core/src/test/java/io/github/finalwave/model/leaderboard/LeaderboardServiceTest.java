...
class LeaderboardServiceTest {
    ...
    private static Quest openQuest(String id, Quest.Category category) {
        return new Quest(
                ...
                noopCondition(),
                io.github.finalwave.model.quest.reward.QuestReward.coins(0));
    }

    private static io.github.finalwave.model.quest.condition.QuestCondition noopCondition() {
        return new io.github.finalwave.model.quest.condition.QuestCondition() {
            @Override
            public void onEvent(io.github.finalwave.model.quest.event.GameEvent event) {
            }
