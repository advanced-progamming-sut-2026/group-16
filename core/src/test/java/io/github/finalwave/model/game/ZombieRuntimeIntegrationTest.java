...
class ZombieRuntimeIntegrationTest {
    ...
    void preTickDeathRunsCleanupExactlyOnce() {
        ...
        ZombieBehavior cleanup = new ZombieBehavior() {
            @Override
            public void execute(Zombie zombie, io.github.finalwave.model.game.entity.GameContext context) {
            }

            @Override
            public void onDeath(Zombie zombie, io.github.finalwave.model.game.entity.GameContext context) {
    ...
    void arcadeMachineIsIndependentAndSurvivesItsPusher() {
        ...
        Zombie arcade = new Zombie.Builder("arcade").maxHealth(1).position(3.5, 1)
                .addBehavior(new io.github.finalwave.model.game.entity.zombie.behavior.ArcadePushBehavior())
                .build();
    ...
    void tombRaiserUsesInjectedRandomForDistinctEmptyCells() {
        GameSession first = new GameSession(plantRegistry, new GameBoard(), 50,
                (io.github.finalwave.model.game.entity.zombie.ZombieFactory) null, 1, new Random(17));
