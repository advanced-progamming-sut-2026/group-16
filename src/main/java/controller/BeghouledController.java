...
public class BeghouledController extends ViewController {

    private final MiniGameHubController hubController;

    public BeghouledController(User user, MiniGameHubController hubController) {
        this.hubController = hubController;
    }

    @Override
    public void displayMenu() {
        getStubView().showComingSoon(MiniGameId.BEGHOULED.getDisplayName());
    }
